        ...
        <div className="hoc">
          ...
          <ul>
            ...
            <li>
              ...
              returns a new component by adding additional functionalities to
              the component. HOC is wrapped in the original component.
            </li>
            <li>
              Higher-Order component is an advanced technique in ReactJS for
              reusing component logic.
            </li>
            <li>
              HOCs are not part of the React API. But, It is a pattern that
